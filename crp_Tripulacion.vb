...
Public Class crp_Tripulacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PortalSIAC.crp_Tripulacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrp_Tripulacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crp_Tripulacion = New crp_Tripulacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
