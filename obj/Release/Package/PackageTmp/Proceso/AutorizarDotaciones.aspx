<%@ Page Title="Proceso>Autorizar Dotaciones" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master"
    CodeBehind="AutorizarDotaciones.aspx.vb" Inherits="PortalSIAC.AutorizarDotaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset id="fst_AutorizarDotaciones" runat="server" style="border: 1px solid Gray; padding-left: 5px">
        ...
        <asp:GridView ID="gv_DotacionesActivas" runat="server" AutoGenerateColumns="False"
            ...
            CssClass="gv_general" DataKeyNames="Id_DotacionCli,IdCajaB,IdCP,IdS,IdM,CantSobres,Comentarios,Conexion" AllowPaging="True" PageSize="25">
            <Columns>
                ...
                <asp:BoundField DataField="Solicita" HeaderText="Solicita" HeaderStyle-HorizontalAlign="Left">
    ...
    <fieldset id="fst_detalleDotacion" runat="server" style="border: 1px solid Gray; padding-left: 5px">
        ...
        <asp:GridView ID="gv_Detalle" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="gv_general" Width="40%">
            <Columns>
